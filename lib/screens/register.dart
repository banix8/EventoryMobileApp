...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<List> _registration() async { //added by Jhunes
    final response =
        await http.post("http://192.168.56.1/mobile_eventory/login.php", body: {
      "event": "register",
      "name": _fullnameControl.text,
      "email": _emailControl.text,
      "password": _passwordControl.text,
      "accountType": _picked
    });
    print(response.body);
    print(_fullnameControl.text);
